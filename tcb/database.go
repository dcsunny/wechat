...
func (tcb *Tcb) DatabaseMigrateImport(req *DatabaseMigrateImportReq) (*DatabaseMigrateImportRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseMigrateImportRes, "DatabaseMigrateImport")
...
func (tcb *Tcb) DatabaseMigrateExport(req *DatabaseMigrateExportReq) (*DatabaseMigrateExportRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseMigrateExportRes, "DatabaseMigrateExport")
...
func (tcb *Tcb) DatabaseMigrateQueryInfo(env string, jobID int64) (*DatabaseMigrateQueryInfoRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseMigrateQueryInfoRes, "DatabaseMigrateQueryInfo")
...
func (tcb *Tcb) UpdateIndex(req *UpdateIndexReq) error {
	...
	return common_error.DecodeWithCommonError(tcb.Context, response, "UpdateIndex")
}
...
func (tcb *Tcb) DatabaseCollectionAdd(env, collectionName string) error {
	...
	return common_error.DecodeWithCommonError(tcb.Context, response, "DatabaseCollectionAdd")
}
...
func (tcb *Tcb) DatabaseCollectionDelete(env, collectionName string) error {
	...
	return common_error.DecodeWithCommonError(tcb.Context, response, "DatabaseCollectionDelete")
}
...
func (tcb *Tcb) DatabaseCollectionGet(env string, limit, offset int64) (*DatabaseCollectionGetRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseCollectionGetRes, "DatabaseCollectionGet")
...
func (tcb *Tcb) DatabaseAdd(env, query string) (*DatabaseAddRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseAddRes, "DatabaseAdd")
...
func (tcb *Tcb) DatabaseDelete(env, query string) (*DatabaseDeleteRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseDeleteRes, "DatabaseDelete")
...
func (tcb *Tcb) DatabaseUpdate(env, query string) (*DatabaseUpdateRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseUpdateRes, "DatabaseUpdate")
...
func (tcb *Tcb) DatabaseQuery(env, query string) (*DatabaseQueryRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseQueryRes, "DatabaseQuery")
...
func (tcb *Tcb) DatabaseCount(env, query string) (*DatabaseCountRes, error) {
	...
	err = common_error.DecodeWithError(response, databaseCountRes, "DatabaseCount")
